...
function TestimonialCard({
  ...
  return (
    <a
      ...
      className={cn(
        "relative flex h-auto min-h-[140px] sm:min-h-[180px] w-[260px] sm:w-[380px] -skew-y-[8deg] select-none flex-col rounded-2xl border border-border bg-card/90 backdrop-blur-sm px-3 sm:px-4 py-3 sm:py-4 transition-all duration-500 hover:border-primary/40 hover:bg-card cursor-pointer",
    ...
    >
      ...
      <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
        <div className="size-9 sm:size-12 rounded-full bg-gradient-to-br from-primary/60 via-primary/40 to-primary/20 flex items-center justify-center overflow-hidden shrink-0 border border-primary/30">
          {avatar ? (
  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Rafaela",
      username: "Rafaela M.",
      handle: "@rafaela_osasco",
      content: "Comprei meu iPhone aqui e chegou no mesmo dia! 🚀 Embalado with muito cuidado e o atendimento pelo WhatsApp foi incrível. Super recomendo a JR acessorios! ⭐⭐⭐⭐⭐",
      date: "Abr 2025",
      verified: true,
      likes: 87,
      retweets: 14,
      tweetUrl: INSTAGRAM_URL,
    },
    {
      className: "[grid-area:stack] translate-x-8 sm:translate-x-16 translate-y-6 sm:translate-y-10 hover:-translate-y-1 before:absolute before:w-[100%] before:outline-1 before:rounded-2xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/60 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Carlos",
      username: "Carlos S.",
      handle: "@carlos_tech_sp",
      content: "Melhor loja de acessórios da região! 💯 Case e película de qualidade, preço justo e entrega no mesmo dia. Já é a terceira vez que compro aqui. Produto 100% original com nota fiscal!",
      date: "Mar 2025",
      verified: true,
      likes: 63,
      retweets: 9,
    ...
    },
    {
      ...
      username: "Marcos T.",
      handle: "@marcos_carapicuiba",
      content: "Atendimento personalizado no WhatsApp, me ajudaram a escolher o smartwatch ideal pro meu estilo. Chegou super rápido, produto original e com garantia. Nota 10! 👏🏆",
      date: "Fev 2025",
      verified: true,
      likes: 142,
      retweets: 27,
